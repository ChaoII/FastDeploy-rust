...
pub fn test_segmentation() {
    let model_file = "demo/demo_files/models/Portrait_PP_HumanSegV2_Lite_256x144_with_argmax_infer/model.pdmodel";
    let param_file = "demo/demo_files/models/Portrait_PP_HumanSegV2_Lite_256x144_with_argmax_infer/model.pdiparams";
    let config_file = "demo/demo_files/models/Portrait_PP_HumanSegV2_Lite_256x144_with_argmax_infer/deploy.yaml";
    let runtime_option = RuntimeOption::new();
    runtime_option.use_ort_backend();
